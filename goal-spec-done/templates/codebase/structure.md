...
├── goal-spec-done/     # Skill resources
...
**New Template:**
- Implementation: `goal-spec-done/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `goal-spec-done/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/goal-spec-done/workflows/{name}.md`

**New Reference Document:**
- Implementation: `goal-spec-done/references/{name}.md`

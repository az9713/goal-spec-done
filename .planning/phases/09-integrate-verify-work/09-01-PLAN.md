...
@goal-spec-done/workflows/discuss-phase.md

**Pattern references (existing GSD templates to match):**
@goal-spec-done/templates/context.md
@goal-spec-done/templates/issues.md
</context>
...
<task type="auto">
  ...
  <files>goal-spec-done/workflows/verify-work.md</files>
  <action>
...
- Reference template for issues format: `@~/.claude/goal-spec-done/templates/uat-issues.md`
...
- Offer next actions based on results
  ...
  <verify>File exists at goal-spec-done/workflows/verify-work.md with proper XML structure</verify>
...
<task type="auto">
  ...
  <files>goal-spec-done/templates/uat-issues.md</files>
  <action>
...
- No "Closed Enhancements" section (issues are fixed via FIX.md plan, then file is historical record)
  ...
  <verify>File exists at goal-spec-done/templates/uat-issues.md with proper template structure</verify>
...
- Update execution_context to reference workflow: `@~/.claude/goal-spec-done/workflows/verify-work.md`
- Add template reference: `@~/.claude/goal-spec-done/templates/uat-issues.md`
...
- [ ] `goal-spec-done/workflows/verify-work.md` exists with proper XML structure
- [ ] `goal-spec-done/templates/uat-issues.md` exists with template format
